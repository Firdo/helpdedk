...
$query="SELECT * FROM changeticket WHERE id= ? LIMIT 0,1";
...
<div class="row">
    <div class="col-md-3">
       <a href="viewchange.php"><button class="btn">Back</button> </a>
    </div>
    </div>
    </div><br>
<div class="container-fluid">
...
$query="UPDATE changeticket SET name=:name, finish=:finish, mobile=:mobile, rootcause =:rootcause, handledby =:handledby, status =:status,actiontaken=:actiontaken, solvedby =:solvedby,closedtime=:closedtime WHERE  id =:id";
