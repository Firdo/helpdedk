...
$query="SELECT issue.problem,issue.name,issue.time,problemticket.actiontaken,issue.status,issue.critical,issue.rootcause,issue.ticket,problemticket.closedtime,problemticket.solvedby FROM issue INNER join problemticket on issue.id=problemticket.id Where issue.id= ? LIMIT 0,1";
...
<div class="row">
    <div class="col-md-3">
       <a href="userview.php"><button class="btn">Back</button> </a>
    </div>
    </div>
    </div><br>
<div class="container-fluid">
