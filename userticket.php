        ...
        <form method="POST" action="">
            <div class="form-row">
                ...
                <div class="form-row">
                   ...
                   <input type="text" class="form-control" value="<?php echo $row[handledby];?>" readonly>
                </div>
                 ...
                 <div class="form-group col-md-4">
                   ...
                   <input type="text" name="timetaken" class="form-control" value="<?php echo $row[finish];?>" readonly> 
                </div>
                 </div>
                 <br>
                 <div class="form-row">
