...
if($_POST['submit']){
    ...
    $query="INSERT INTO changeticket SET id=:id,changerequest=:changerequest,actiontaken=:actiontaken,handledby=:handledby,time=:time";
   $stmt=$con->prepare($query);
   $stmt->bindParam(':id', $id); 
   $stmt->bindParam(':changerequest', $changerequest);  
   ...
   if($stmt->execute()){
    ...
    echo "<script>alert('Change Ticket Has Been Registered Successfully!');</script>";
   }
      else{
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                 ...
                 <div class="form-group col-md-4">
                    ...
                    <input type="text" name="changerequest" class="form-control">
                </div>
